#
# Copyright 2012-2014 Stefan Ulbrich, Luke Frisken, Bronto Software, Inc. and contributors
#
...
class RustDomain(Domain):
    ...
    def resolve_xref(self, env, fromdocname, builder, typ, target, node, contnode):
        ...
        def make_ref(fullname): 
            make_refnode(builder, fromdocname, objects[fullname][0], fullname, contnode, fullname)
